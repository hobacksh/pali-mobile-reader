...
TARGET_XML = ROOT_DIR / "data/corpus/ko/s0402m1.mul.xml"
...
def main():
    ap = argparse.ArgumentParser(
        description="s0402m1.mul.xml trans=false 단락을 배치 번역하고 trans=true로 반영"
    )
    ...
    ap.add_argument("--model", default="gpt-5.4", help="codex model")
